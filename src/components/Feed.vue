<template>
  <div class="feed">
    <div class="feed_image">
      <div class="feed_image_shadow"
           :style="shadowFilter"></div>
    ...
    <div class="feed_content">
      ...
      <p>
        {{ feed.author.name }}
        <span class="feed_content_text"
              v-html="emphasizeContent"></span>
      </p>
    </div>
  </div>
</template>
